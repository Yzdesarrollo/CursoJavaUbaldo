...
public class PrimitivosEnteros {
    ...
    public static void main(String[] args) {
        ...
        // TIPOS PRIMITIVOS ENTEROS SON:
        //byte, short, int, long
        byte byteVar = 127;
        System.out.println("byteVar = " + byteVar);

        // Para saber el rango maximo
        System.out.println("bits tipo byte:" + Byte.SIZE);
        
        // Para saber el numero de bits
        ...
        // Para saber cuales son sus limites de este tipo
        ...
        // Para saber cuales son sus limites de este tipo
        long longVar = 9223372036854775807L; // Menejo de literales o valor de la literal
        ...
        // Cuando usamos var por defecto viene con tipo int por eso debemos usar la literal para indicarle a java
